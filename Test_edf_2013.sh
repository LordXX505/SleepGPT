...
srun python3 main_test_kfold.py with finetune_edf   \
  num_gpus=1 num_nodes=1 num_workers=4 batch_size=64 model_arch=backbone_large_patch200  lr_mult=20 \
  ...
  lr=1e-3 min_lr=0 random_choose_channels=8 max_epoch=60 lr_policy=cosine loss_function='l1' drop_path_rate=0.5 warmup_steps=0.1 split_len=20 \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=3 grad_name='all' \
  kfold_test=0 eval=True dist_on_itp=False EDF_Mode='2013_Finetune'
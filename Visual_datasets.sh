...
srun python3 main_test_last.py with visualization visualization_using_all_fft SHHS1_datasets   \
  num_gpus=1 num_nodes=1 num_workers=4 batch_size=512 model_arch=backbone_large_patch200  lr_mult=20 \

...
#SBATCH --output=/home/cuizaixu_lab/huangweixuan/DATA/temp_log/edf_portion_mix/%j.out
...
srun python3 main_kfold.py with finetune_edf  edf_portion_12_datasets  edf_datasets \
  num_gpus=2 num_nodes=1 num_workers=8 batch_size=12 model_arch=backbone_large_patch200  lr_mult=20 \
  ...
  resume_during_training=0 resume_ckpt_path="" kfold=1 use_triton=False actual_channels='EDF' \

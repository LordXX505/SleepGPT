...
srun python3 main_test_kfold.py with finetune_edf edf_ft_TCC   seed=2023 \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=0 grad_name='all' \
  kfold_test=0 eval=True dist_on_itp=False subset=0.05

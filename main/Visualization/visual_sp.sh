...
#
#srun python3 main/Visualization/visual_sp.py with visualization  visualization_using_all_fft   Young_datasets \
...
#  expert=None IOU_th=0.2 sp_prob=0.55 patch_time=30 dist_on_itp=False mask_strategies=None

...
#load_path=/home/cuizaixu_lab/huangweixuan/DATA_C/data/checkpoint/Unify_cosine_backbone_large_patch200_l1_pretrai/version_1/ModelCheckpoint-epoch=04-val_acc=0.0000-val_score=4.0899.ckpt
...
srun python3 main/Visualization/visual_sp.py with visualization  visualization_using_all_fft   edf_aug_all_datasets \
  ...
  expert=None IOU_th=0.2 sp_prob=0.55 patch_time=30 dist_on_itp=False mask_strategies='mask_channel'

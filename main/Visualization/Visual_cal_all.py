...
def visual(batch, pl_module, persub):
    ...
    # print('save fft png')
    # os.makedirs(f"/home/cuizaixu_lab/huangweixuan/Sleep/{path}/{_config['datasets'][_]}/epoch_{match}", exist_ok=True)
    # plt.savefig(f"/home/cuizaixu_lab/huangweixuan/Sleep/{path}/{_config['datasets'][_]}/epoch_{match}/predict_fft_nu_{id}.svg",  format='svg')
    # plt.close("all")

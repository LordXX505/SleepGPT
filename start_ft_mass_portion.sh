...
srun python3 main_kfold.py with finetune_mass_stage  MASS2_datasets   \
  num_gpus=2 num_nodes=1 num_workers=18 batch_size=6 model_arch=backbone_large_patch200  lr_mult=20 \
  ...
  resume_during_training=0 resume_ckpt_path="" kfold=5  mode='Finetune_mass_portion_12' \

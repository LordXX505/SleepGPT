...
srun python3 main_test_last.py with finetune_edf   edf_2018 \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True grad_name='all' return_alpha=True eval=True dist_on_itp=False \

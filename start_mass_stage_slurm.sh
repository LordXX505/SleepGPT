...
srun python3 main_kfold.py with finetune_mass_stage   \
  num_gpus=8 num_nodes=1 num_workers=32 batch_size=6 model_arch=backbone_large_patch200  lr_mult=20 \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=20 grad_name='all' \
  resume_during_training=0 resume_ckpt_path="" \

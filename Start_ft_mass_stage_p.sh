...
srun python3 main_kfold.py with finetune_mass_stage  MASS1_datasets mode='Finetune_mass_ss1' \
  num_gpus=4 num_nodes=1 num_workers=16 batch_size=64 model_arch=backbone_large_patch200  lr_mult=20 \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=5 grad_name='all' \
